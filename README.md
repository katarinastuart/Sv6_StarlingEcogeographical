...
I truely appologise for the next piece of code. I was trying to apply unix loop logic to R, and it got messy. I am sure the same thing can be achieved with a much neater R function, however at the time I was blisfully unaware that this was an option. I'll run through an example for one phenotype: mass.
